...
- Zone labels look flipped or misplaced: check whether the map was drawn from the architectural top-down room diagram. `config/zones.json` must be calibrated from the camera image perspective: Z1 bottom-left/camera-side, Z2 middle-right/lower-mid, Z3 left/mid, Z4 top-right, Z5 upper-middle, Z6 top-left.
